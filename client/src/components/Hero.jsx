...
const Hero = () => {
  ...
  return (
    <div className="container 2xl:px-20 mx-auto my-10">
      <div
        className="bg-gradient-to-r from bg-purple-800 to-purple-950 
      ...
      >
        ...
        <div
         ...
         text-gray-600 max-w-xl pl-4 mx-4 sm:mx-auto"
        >
      ...
      <div className="border border-gray-200 shadow-md mx-2 mt-5 p-6 rounded flex">
