    ...
    <>
      ...
      <div className="min-h-screen flex flex-col py-10 container px-4 mx-auto">
        <div className="bg-white text-black rounded-lg w-full">
          <div className="flex justfy center md: justify-between flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border border-sky-400 rounded-xl">
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="text-center md:text-left text-neutral-700">
                ...
                <div className="flex flex-row flex-wrap max:mdjustify-center gap-y-2 gap-6 items-center text-gray-600 mt-2">
